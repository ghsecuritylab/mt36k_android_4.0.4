...
#ifndef _I_MTK_PB_DRM_H_
#define _I_MTK_PB_DRM_H_
 ...
 */
extern IMTK_PB_ERROR_CODE_T IMtkPb_DRM_Init(void);
 ...
 *  @see            IMtkPb_DRM_Init()
 */
extern IMTK_PB_ERROR_CODE_T IMtkPb_DRM_Terminate(void);
 ...
 */
extern IMTK_PB_ERROR_CODE_T IMtkPb_DRM_SecureStorage_Load(const char*   pcSrcPath,
 ...
 */
extern IMTK_PB_ERROR_CODE_T IMtkPb_DRM_SecureStorage_Save(const char*   pcSrcPath,
                                                          const char*   pcDstPath);
 ...
 *  @see
 */
extern IMTK_PB_ERROR_CODE_T IMtkPb_DRM_SecureStorage_Cleanup(const char*    pcFilePath);
 ...
 */
extern IMTK_PB_ERROR_CODE_T IMtkPb_DRM_SecureStorage_Read(const char*   pcSrcPath,
                                                          char*         pcData,
                                                          uint32_t      u4Length);
 ...
 */
extern IMTK_PB_ERROR_CODE_T IMtkPb_DRM_SecureStorage_Write(const char*  pcDstPath,
                                                           const char*  pcData,
                                                           uint32_t     u4Length);
 ...
 *  @see
 */
extern IMTK_PB_ERROR_CODE_T IMtkPb_DRM_AES_CTR(const char* pcKey,
