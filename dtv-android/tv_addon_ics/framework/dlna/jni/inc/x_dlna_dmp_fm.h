...
*/
/*----------------------------------------------------------------------------*/
extern INT32 x_dlna_dmp_fm_open(DLNA_DMP_OBJECT_T t_object, INT32 *pi4_fd);
...
*/
/*----------------------------------------------------------------------------*/
extern INT32 x_dlna_dmp_fm_read_async(INT32 i4_fd, VOID *pv_data, UINT32 ui4_count, UINT8 ui1_pri, x_dlna_fm_async_fct pf_nfy_fct, VOID *pv_tag, INT32 *pi4_req);
...
extern INT32 x_dlna_dmp_fm_alloc_info(DLNA_DMP_OBJECT_T t_object, DLNA_DMP_OBJECT_FM_T ** ppt_fm);

extern INT32 x_dlna_dmp_fm_free_info(DLNA_DMP_OBJECT_FM_T ** ppt_fm);

extern INT32 x_dlna_dmp_fm_open_by_info(DLNA_DMP_OBJECT_FM_T * pt_fm, INT32 *pi4_fd);
