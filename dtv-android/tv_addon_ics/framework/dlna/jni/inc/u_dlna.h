...
typedef enum {
    DLNA_FM_COND_TIMEOUT         = -3,
    DLNA_FM_COND_ABORT_FAIL      = -2,
    DLNA_FM_COND_FAIL            = -1,
    DLNA_FM_COND_OK              = 1,
    DLNA_FM_COND_ABORT_OK        = 3,
    DLNA_FM_COND_EOF             = 4,
    DLNA_FM_COND_NO_RESPENSE     = 5,
} DLNA_FM_ASYNC_COND_T;
...
enum {
    ...
    DLNA_FMR_BUSY           =  -12,
    DLNA_FMR_EOF            =  -13, 
    DLNA_FMR_NOT_INIT       =  -18, 
    DLNA_FMR_DEVICE_ERROR   =  -21, 
    DLNA_FMR_NOT_ENOUGH_SPACE   =  -23, 
    DLNA_FMR_TIMEOUT          = -36,
    DLNA_FMR_ERROR          =  -99,      
};

typedef VOID (*x_dlna_fm_async_fct) (HANDLE_T h_req, VOID * pv_tag, DLNA_FM_ASYNC_COND_T e_cond, UINT32 ui4_data);

#define FM_SEEK_BGN 1
#define FM_SEEK_CUR 2
#define FM_SEEK_END 3
