...
/* DLNA object file manager info */
/*----------------------------------------------------------------------------*/
/*! @struct DLNA_DMP_OBJECT_FM_T
*  @brief   DLNA DMP object file manager info
*  @code
*  typedef struct _DLNA_DMP_OBJECT_FM_T
*  {
*        INT32      i4_flag;                             // file manager flag
*       INT32      i4_media_type;                  //media type
*       INT32      i4_drm_type;                    //DRM type
*       UINT64    ui8_size;                        // file size
*       CHAR *    ps_uri;                           //resource uri
*       CHAR *    ps_session_id;                // wmdrm session id
*  } DLNA_DMP_OBJECT_INFO_T;
*  @endcode
*
*  @li@c    i4_flag;                        - file manager flag
*  @li@c   i4_media_type;             -  media type
*  @li@c   i4_drm_type;                 - DRM type
*  @li@c   ui8_size;                       - file size
*  @li@c   ps_uri;                          - resource uri
*  @li@c   ps_session_id;               - wmdrm session id
*
*/
/*----------------------------------------------------------------------------*/
typedef struct _DLNA_DMP_OBJECT_FM_T
{
    ...
    INT32      i4_drm_type;    /* DRM type */
    UINT64     ui8_size;       /* file size */
    UINT32     ui4_id_length;  /* session id length */
    CHAR *     ps_uri;         /* resource uri */
    CHAR *     ps_dtcp_info;
    UINT8 *    pui1_session_id;  /* wmdrm session id */
    CHAR *     ps_mime;             /* the object MIME type */
} DLNA_DMP_OBJECT_FM_T  ;
