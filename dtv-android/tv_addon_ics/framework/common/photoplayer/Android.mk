...
PRODUCT_COPY_FILES += \
    $(LOCAL_PATH)/com.mediatek.common.PhotoPlayer.xml:system/etc/permissions/com.mediatek.common.PhotoPlayer.xml
...
LOCAL_MODULE:= com.mediatek.common.PhotoPlayer
LOCAL_SHARED_LIBRARIES += libmtal_static
...
#LOCAL_SRC_FILES := 
LOCAL_C_INCLUDES += $(TOPDIR)../../chiling/app_if/mtal/mtal_inc/
LOCAL_MODULE:= PhotoPlayer
