...
#include <sys/time.h>
#include <sys/wait.h>
//#include <sys/fcntl.h>//mod by HQS,because android changed its directory
#include <fcntl.h>
...
#define TAG_EOL		9
/*
static int tag_map[10] = { PTT_SRV_NAME,
			 PTT_AC_NAME,
			 PTT_HOST_UNIQ,
			 PTT_AC_COOKIE,
			 PTT_VENDOR,
...
char IPlocal[32], IPremote[32],DNS1[32],DNS2[32],pInterface[32];
...
#endif
//add for ppp interface report--HQS
#define PORT   9080   
