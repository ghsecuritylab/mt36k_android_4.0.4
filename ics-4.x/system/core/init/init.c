...
static char *console_name = "/dev/ttyMT0";      /*"/dev/console";*/
...
struct mtd_part_t mtd_part_map[16];
...
void execute_one_command(void)
{
	...
	PROFILE("command '%s %s' r=%d\n", cur_command->args[0],
                                    (cur_command->nargs > 1 ? cur_command->args[1] : ""), ret);
#else
...
#ifdef INIT_PROFILING
	PROFILE("finish reading config file\n");
#endif
