...
snprintf(dns_prop_name, sizeof(dns_prop_name), "dhcp.%s.dns1", ifname);
    ...
    property_set(dns_prop_name, dns1 ? ipaddr_to_string(dns1) : "");
    snprintf(dns_prop_name, sizeof(dns_prop_name), "net.dns2");
    property_set(dns_prop_name, dns2 ? ipaddr_to_string(dns2) : "");


   snprintf(dns_prop_name, sizeof(dns_prop_name), "dhcp.%s.ipaddress", ifname);
    property_set(dns_prop_name,  address ? ipaddr_to_string(address) : "");

    snprintf(dns_prop_name, sizeof(dns_prop_name), "dhcp.%s.gateway", ifname);
    property_set(dns_prop_name, gateway ? ipaddr_to_string(gateway) : "");

    snprintf(dns_prop_name, sizeof(dns_prop_name), "dhcp.%s.server", ifname);
    property_set(dns_prop_name, address ? ipaddr_to_string(address) : "");

   snprintf(dns_prop_name, sizeof(dns_prop_name), "dhcp.%s.leasetime", ifname);
    property_set(dns_prop_name, "360000");

   snprintf(dns_prop_name, sizeof(dns_prop_name), "dhcp.%s.result", ifname);
    property_set(dns_prop_name, "ok");
