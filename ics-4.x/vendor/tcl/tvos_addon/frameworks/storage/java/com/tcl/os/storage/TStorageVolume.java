...
public class TStorageVolume implements Parcelable{
 //private static final String TAG = "TTStorageVolume";
    ...
    // TTStorageVolume extra for ACTION_MEDIA_REMOVED, ACTION_MEDIA_UNMOUNTED, ACTION_MEDIA_CHECKING,
    // ACTION_MEDIA_NOFS, ACTION_MEDIA_MOUNTED, ACTION_MEDIA_SHARED, ACTION_MEDIA_UNSHARED,
    // ACTION_MEDIA_BAD_REMOVAL, ACTION_MEDIA_UNMOUNTABLE and ACTION_MEDIA_EJECT broadcasts.
    public static final String EXTRA_STORAGE_VOLUME = "storage_volume";

    public TStorageVolume(String path, String description, boolean removable,
    ...
    public boolean equals(Object obj) {
        if (obj instanceof TStorageVolume && mPath != null) {
            TStorageVolume volume = (TStorageVolume)obj;
    ...
    public String toString() {
        return "TStorageVolume [mAllowMassStorage=" + mAllowMassStorage + ", mDescription="
    ...
    public static final Parcelable.Creator<TStorageVolume> CREATOR =
        new Parcelable.Creator<TStorageVolume>() {
        public TStorageVolume createFromParcel(Parcel in) {
            ...
            return new TStorageVolume(path, description,
