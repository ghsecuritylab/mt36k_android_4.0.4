...
/**
  ...
  *caosm add for audio channel save in dtv

  */

public static String CFG_AUDIO_CHANNEL_DTV          = CFG_GRP_AUDIO_PREFIX + "audio_channel_dtv";
...
public static String CFG_FAC_DBC_EN          		  	   = CFG_GRP_FAC_PREFIX + "dbc_en";
public static String CFG_FAC_DBC_EN_FUNC           		   = CFG_GRP_FAC_PREFIX + "dbc_en_func";
...
public static String CFG_NO_SIGNAL_FUNC	                 = CFG_GRP_D_CUST_PREFIX + "no_signal_func";
public static String CFG_PIC_MODE_VIVID_FUNC			 = CFG_GRP_D_CUST_PREFIX + "picture mode vivid flag";
/*-----------------------------------------------------------------------------
