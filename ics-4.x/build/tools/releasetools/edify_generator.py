...
# Begin add by TCL kevin, mail: qik@tcl.com 2015.10.28
  def CleanDataDir(self):
    ...
    if fstab:
      p = fstab[mount_point]
      self.script.append('clean_datadir("%s", "%s", "%s", "%s");' %
                         (p.fs_type, p.device, p.mount_point,"com.tcl.mtk.mtkVersionUpdate"))
  # End of TCL
