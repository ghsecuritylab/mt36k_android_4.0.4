...
#########################################################
## from dtv froyo 2.2 - release custom build
########################################################

ifeq "$(RLS_CUSTOM_BUILD)" "true"
ICS_DIR := $(word 1, $(subst /platform/,/platform /, $(shell bash -c pwd -L)))
#LOCAL_CLASSPATH += $(ICS_DIR)/device/mediatek/mt8580/xxx.jarr
ANDROID_DIR := $(word 1, $(subst /ics-4.x/,/ics-4.x /, $(shell bash -c pwd -L)))
LOCAL_CLASSPATH += $(ANDROID_DIR)/device/mtk/mt5396/prebuilt/classes/com.mediatek.media.jar
LOCAL_CLASSPATH += $(ANDROID_DIR)/device/mtk/mt5396/prebuilt/classes/com.mediatek.tv.jar
LOCAL_CLASSPATH += $(ANDROID_DIR)/device/mtk/mt5396/prebuilt/classes/com.mediatek.pppoe.jar
LOCAL_CLASSPATH += $(ANDROID_DIR)/device/mtk/mt5396/prebuilt/classes/com.mediatek.tvcm.jar
LOCAL_CLASSPATH += $(ANDROID_DIR)/device/mtk/mt5396/prebuilt/classes/com.mediatek.common.capture.jar
LOCAL_CLASSPATH += $(ANDROID_DIR)/device/mtk/mt5396/prebuilt/classes/com.mediatek.common.PhotoPlayer.jar
LOCAL_CLASSPATH += $(ANDROID_DIR)/device/mtk/mt5396/prebuilt/classes/com.mediatek.dlna.jar
LOCAL_CLASSPATH += $(ANDROID_DIR)/device/mtk/mt5396/prebuilt/classes/jcifs.jar
