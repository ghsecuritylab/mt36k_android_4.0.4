...
public class Settings {
    ...
    public static void writeBack() {
        ...
        editor.putBoolean(ANDPY_CONFS_KEYSOUND_KEY, false );  //mKeySound
    ...
    private void initConfs() {
        mKeySound = mSharedPref.getBoolean(ANDPY_CONFS_KEYSOUND_KEY, false);  //true
    ...
    public static boolean getKeySound() {
       // return mKeySound;
	return true;//change by hut,open voice 2013-2-21;
    }
