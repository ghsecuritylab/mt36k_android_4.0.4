...
class Tab implements PictureListener {
    ...
    private final WebChromeClient mWebChromeClient = new WebChromeClient() {
        ...
        // -- MTK_WEBKIT_FIX START --
        @Override
        public void onStartVideoStreaming(WebView view) {
            ...
            Log.e(LOGTAG, "Got onStartVideoStreaming() callback, mtkCachePolicy =" + mtkCachePolicy);

            if(1 == mtkCachePolicy){
                TabControl tabControl = mWebViewController.getTabControl();

                for (int pos = 0; pos < tabControl.getTabCount(); pos++) {
                    Tab tab = tabControl.getTab(pos);
