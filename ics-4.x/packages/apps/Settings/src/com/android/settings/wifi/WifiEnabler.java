...
public class WifiEnabler implements CompoundButton.OnCheckedChangeListener  {
    ...
    public void setSwitch(Switch switch_) {
        ...
        boolean isInit = wifiState == WifiManager.WIFI_STATE_UNKNOWN;
        mSwitch.setChecked(isEnabled);
        mSwitch.setEnabled(isEnabled || isDisabled || isInit);
    }
    ...
    public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
        ...
        if (mStateMachineEvent) {
			  Log.d(TAG, "onCheckedChanged---->mStateMachineEvent");
            return;
        }
        ...
        if (mWifiManager.setWifiEnabled(isChecked)) {
            ...
            Log.d(TAG, "setWifiEnabled---->ischecked");
