...
public class WifiSettings extends SettingsPreferenceFragment
    ...
    private void updateWifiState(int state) {
		...
		Log.e("sunhao","******************mWifiManager.wifi0Check()_______________:"+mWifiManager.wifi0Check()+"__state_:"+state);
		if(mWifiManager.wifi0Check()<0 && state!=WifiManager.WIFI_STATE_DISABLED && state!=WifiManager.WIFI_STATE_ENABLING){
			 addMessagePreference(R.string.wifi_no_netcard);
		}
        mLastInfo = null;
        mLastState = null;
        mScanner.pause();
