...
//		mNavIntegration = NavChannel.getInstance(mContext);
	...
	public boolean onKeyDown(int keyCode, KeyEvent event) {
		...
		case KeyMap.KEYCODE_MTKIR_EJECT:
			...
			if (selectedChannel .equals( mNavIntegration.iGetCurrentChannel())) {
				...
				if (mNavIntegration.iGetCurrentChannel().isFavorite()) {
	...
	private void updateFavList() {
		...
		mFavChannelDataList = new ListData<TVChannel>(mNavIntegration
				.iGetFavoriteList(), curChannel);
		mFavChannelDataList.updateAllData(mNavIntegration.iGetFavoriteList());

		mChannelAdapter = new ChannelAdapter(mContext, mFavChannelDataList
				.getShowData(mNavIntegration.iGetCurrentChannel()));
		...
		MtkLog.d(TAG, "mFavChannelDataList.getIdxInShowList(curChannel) = " + tmp);
	...
	protected void onStart() {
		...
		mNavFavoriteSelectString = mContext.getResources().getString(R.string.nav_favorite_select);
		...
		public boolean onKey(View v, int keyCode, KeyEvent event) {
			...
			if (event.getAction() == KeyEvent.ACTION_DOWN) {
				...
				case KeyEvent.KEYCODE_DPAD_CENTER:
					...
					MtkLog.v(TAG, "mChannelItemKeyLsner*********** selectPosition"
