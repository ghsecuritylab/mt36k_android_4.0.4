...
//			mContext = null;
	...
	public void changeVideoTrackNumber() {
		...
		try {
			...
			mLogicManager.setAudioTranckNumber((short) (currentTrack - 1));
...
//			}
	...
	private void findTextView() {
		// vPRepeat = (LinearLayout)
		// vControlView.findViewById(R.id.mmp_pop_repeat);
	...
	public void setVideoSubtitle(short number, short index) {
		if (number <= 0) {
			...
			if (index < 0) {
				mLogicManager.setSubtitleTrack((short)255);//setSubOnOff(false);
