...
//		mtkCfg = (MTKTVConfigurer) tv.getConfigurer();
	...
	// PQ DEMO FUNC
	public static final String PQDEMOFUNC = "UNDEFINE_PQDEMOFUNC";
	// PQ DEMO TYPE
	public static final String PQDEMOTYPE = ConfigType.CFG_PQ_DEMO_TYPE;
	// PQ DEMO ACTION
	public static final String PQDEMOACTION = "UNDEFINE_PQDEMOACTION";
	...
	public static final String NETWORK_CONNECTION = "SETUP_network_connection";
	public static final String NETWORK_INTERFACE = "SETUP_network_interface";
	...
	public static final String NETWORK_INFO = "SETUP_net_information";
	...
	public static final String SETUP_IP_ADDRESS = "SETUP_ip_address";
	public static final String SETUP_SUBNET = "SETUP_subnet";
	public static final String SETUP_DEFAULT_GATE = "SETUP_default_gate";
	public static final String SETUP_IP_DNS = "SETUP_ip_dns";
	public static final String SETUP_IP_DNS2 = "SETUP_ip_dns2";
	...
	public static final String FACTORY_TV_DBOX=TVConfigurer.FACTORY_TV_DBOX;
	
	public static final String FACTORY_TV_DBOX_CVBS_DELAY=TVConfigurer.FACTORY_TV_DBOX_CVBS_DELAY;
	public static final String FACTORY_TV_DBOX_TVD_CHECK=TVConfigurer.FACTORY_TV_DBOX_TVD_CHECK;
	public static final String FACTORY_TV_DBOX_CVBS_SWING=TVConfigurer.FACTORY_TV_DBOX_CVBS_SWING;
	public static final String FACTORY_TV_DBOX_SNOW_GEN=TVConfigurer.FACTORY_TV_DBOX_SNOW_GEN;
	public static final String FACTORY_TV_DBOX_TVD_GAIN=TVConfigurer.FACTORY_TV_DBOX_TVD_GAIN;
	public static final String FACTORY_TV_DBOX_VLOCK_RATIO=TVConfigurer.FACTORY_TV_DBOX_VLOCK_RATIO;
...
//			}
			...
			try {
				TVCommonNative.getDefault(mContext).setTunnerMode(value);
...
//			}
	...
	public void setSetup(String id, int value) {
		...
		} else if (id.equals(NETWORK_CONNECTION)) {
			if (value < 0 || value > 1) {
				value = 0;
			}
			int mode = save.readValue(NETWORK_INTERFACE);
			if (mode == 0) {
				if (value == 0) {
					netWork.openInternetConnectSafety(value);
				} else {
					netWork.openInternetConnectSafety(value);
				}
			} else if (mode == 1) {
				if (value == 0) {
					// netWork.setPreventEthernet(false);
					netWork.openInternetConnectSafety(value + 2);
				} else {
					// netWork.openInternetConnectSafety(value - 1);
					netWork.openInternetConnectSafety(value + 2);
				}
			}
		} else if (id.equals(NETWORK_INTERFACE)) {
			if (value < 0 || value > 1) {
				value = 0;
			}
			// ethernet
			if (value == 0) {
				// netWork.setPreventEthernet(true);
				netWork.openInternetConnectSafety(value + 2);
				netWork.openInternetConnectSafety(value + 1);
