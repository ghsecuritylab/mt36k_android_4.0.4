...
public interface ITVCommon extends IInterface {
	 ...
	 * {@link #insertChannel(TVChannel, TVChannel)},
	 * {@link #clearChannels()},
	 * {@link #swapChannel(TVChannel, TVChannel)},
	 * {@link #setTunnerMode(int)},{@link TVChannel#setChannelNum(int)}
	 * and all scan operations.
	 */
	 ...
	 * 
	 * @return Retures the channel number.
	 */
	 ...
	 *            The input source Name.
	 * @param block
	 *            If true and {@link #tempUnblockInputSource(String)}
	 *            never called on this boot up, The input source will be
	 *            blocked.
	 */
	 ...
	 * {@link #tempUnblockInputSource(String)} never be called, this
	 * input source is blocked.
	 * 
	 * @param inputName
	 *            The input source Name.
	...
	/**
	 * @return The currently selected input source. The default screen output is
	 *         the last one when invoke
	 *         {@link #changeInputSource(String, String)}
	 */
	...
	/**
	 * Update state of current screen output.
	 */
	 ...
	 * 
	 * @param mode
	 *            tunner mode, the value is either
	 *            {@link #TUNNER_CABLE} or {@link #TUNNER_AIR}
	 */
	...
	int CLEAR_ALL_AIR_CHANNELS_TRANSACTION = IBinder.FIRST_CALL_TRANSACTION + 36;
	int CLEAR_ALL_CABLE_CHANNELS_TRANSACTION = IBinder.FIRST_CALL_TRANSACTION + 37;
}
