...
public class VideoConst {
	...
	public static final int PLAY_STATUS_INITED = 1;
	public static final int PLAY_STATUS_PREPAREING = 2;
	public static final int PLAY_STATUS_PREPARED = 3;
	public static final int PLAY_STATUS_STARTED = 4;
	public static final int PLAY_STATUS_PLAYED = 5;
	public static final int PLAY_STATUS_SEEKING = 6;
	public static final int PLAY_STATUS_STEP = 7;
	public static final int PLAY_STATUS_PAUSED = 8;
	public static final int PLAY_STATUS_FF = 9;
	public static final int PLAY_STATUS_FR = 10;
	public static final int PLAY_STATUS_SF = 11;
	...
	public static final int MSG_RETRY_PROGRAM = -19;
	/* Player Mode */
	public static final int PLAYER_MODE_MMP = 0;
