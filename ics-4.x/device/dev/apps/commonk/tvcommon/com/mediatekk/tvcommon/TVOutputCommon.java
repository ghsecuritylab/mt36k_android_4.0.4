...
public class TVOutputCommon {
	...
	private TVOutputCommon(Context context) {
		...
		brdcstSrv = (BroadcastService) tvMngr
	...
	public static TVOutputCommon getInstance(Context context) {
		if (tvOutputCommon == null) {
			...
			// add by liuwei03@tcl.com
			tvOutputCommon.getInstanceVideoResolution("main");
			// end by liuwei03@tcl.com
		}
...
//        inst.outputName = output;
	...
	public void stop(String outputName) {
		try {
			inpSrv.stopDesignateOutput(outputName, true);
		} catch (TVMException e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		}
	...
	*/
	...
	public boolean hasSignal(){
		return hasSignal("main");
	}
	public boolean hasSignal(String outputName) {
		try {
            if (inpSrv != null) {
				return InputSignalStatus.SignalStatusLocked == inpSrv.getOutputSignalStatus(outputName);  
            }
        } catch (TVMException e) {
            // TODO Auto-generated catch block
            e.printStackTrace();
