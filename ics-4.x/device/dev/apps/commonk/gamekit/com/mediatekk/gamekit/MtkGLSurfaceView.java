...
public class MtkGLSurfaceView extends SurfaceView implements SurfaceHolder.Callback {
     ...
     */
    public MtkGLSurfaceView(Context context) {
        super(context);
        init();
    }
     ...
     * must call {@link #setRenderer} to register a renderer.
     */
    public MtkGLSurfaceView(Context context, AttributeSet attrs) {   
        super(context, attrs);          
        init();
    } 
...
//                }
    ...
    //Note, we need reserve this contex by default.
