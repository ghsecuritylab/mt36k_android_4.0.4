...
PRODUCT_COPY_FILES += \
    $(LOCAL_PATH)/com.mediatekk.tvcm.xml:system/etc/permissions/com.mediatekk.tvcm.xml
...
LOCAL_SRC_FILES += tvcommon/com/mediatekk/tvcommon/ITVSelectorListener.aidl
...
LOCAL_MODULE := com.mediatekk.tvcm
