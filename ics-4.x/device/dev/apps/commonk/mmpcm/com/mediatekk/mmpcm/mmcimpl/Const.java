package com.mediatekk.mmpcm.mmcimpl;
...
public class Const {
    ...
    public static final int FILE_TYPE_USB = 1;
    public static final int FILE_TYPE_SMB = 2;
    public static final int FILE_TYPE_DLNA = 3;

    public static final int REPEAT_ALL = 0;// repeat all file in current folder
    public static final int REPEAT_ONE = 1;// repeat one file
    public static final int REPEAT_NONE = 2;// play once
