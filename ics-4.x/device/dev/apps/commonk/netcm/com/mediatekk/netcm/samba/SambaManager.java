package com.mediatekk.netcm.samba;
...
public class SambaManager {
	...
	private final static String fileName = "/data/misc/smb/smb_user_info.ini";
	...
	static class MultiMediaFileFilter implements SmbFileFilter {
		public boolean accept(SmbFile arg0) throws SmbException {
			...
			if (arg0.isDirectory() || filename.endsWith(".txt")
					|| filename.endsWith(".3gp") || filename.endsWith(".mp4")
					...
					|| filename.endsWith(".rtttl") || filename.endsWith(".rtx")
					|| filename.endsWith(".ota") || filename.endsWith(".ogg")
					|| filename.endsWith(".wav") || filename.endsWith(".wma")
					|| filename.endsWith(".vob") || filename.endsWith(".jpg")
					|| filename.endsWith(".gif") || filename.endsWith(".png")
					|| filename.endsWith(".bmp") || filename.endsWith(".ts")
					|| filename.endsWith(".webm") || filename.endsWith(".avi")
					|| filename.endsWith(".wmv") || filename.endsWith(".asf")
					|| filename.endsWith(".mov") || filename.endsWith(".mkv")
					|| filename.endsWith(".mpg") || filename.endsWith(".mpeg")
					|| filename.endsWith(".vro") || filename.endsWith(".rm")
					|| filename.endsWith(".ogm") || filename.endsWith(".flv")) {
	...
	static class VideoFileFilter implements SmbFileFilter {
		public boolean accept(SmbFile arg0) throws SmbException {
			...
			filename = filename.toLowerCase();
			if (arg0.isDirectory() || filename.endsWith(".3gp")
					|| filename.endsWith(".mp4") || filename.endsWith(".ts")
					|| filename.endsWith(".webm") || filename.endsWith(".avi")
					|| filename.endsWith(".wmv") || filename.endsWith(".asf")
					|| filename.endsWith(".mov") || filename.endsWith(".mkv")
					|| filename.endsWith(".mpg") || filename.endsWith(".mpeg")
					|| filename.endsWith(".vro") || filename.endsWith(".rm")
					|| filename.endsWith(".ogm") || filename.endsWith(".flv")
					|| filename.endsWith(".rmvb") || filename.endsWith(".vob")
					|| filename.endsWith(".avs") || filename.endsWith(".divx")
					|| filename.endsWith(".mpe") || filename.endsWith(".dat")
					|| filename.endsWith(".asx") || filename.endsWith(".m4v")
					|| filename.endsWith(".tp") || filename.endsWith(".trp")
					|| filename.endsWith(".tts") || filename.endsWith(".m2ts")
					|| filename.endsWith(".mts") || filename.endsWith(".m1v")
					|| filename.endsWith(".m2v") || filename.endsWith(".m4v")
					|| filename.endsWith(".264") || filename.endsWith(".vc1")
					|| filename.endsWith(".flv") || filename.endsWith(".hlv")
					|| filename.endsWith(".pvr") || filename.endsWith(".ram")) {
	...
	static class AudioFileFilter implements SmbFileFilter {
		public boolean accept(SmbFile arg0) throws SmbException {
			...
			filename = filename.toLowerCase();
			if (arg0.isDirectory() || filename.endsWith(".mp3")
					|| filename.endsWith(".wma") || filename.endsWith(".m3u")
					|| filename.endsWith(".m3u8") || filename.endsWith(".wav")
					|| filename.endsWith(".aif") || filename.endsWith(".m4a")
					|| filename.endsWith(".aac") || filename.endsWith(".ac3")
					|| filename.endsWith(".ec3") || filename.endsWith(".pls")
					|| filename.endsWith(".wpl") || filename.endsWith(".ogg")
					|| filename.endsWith(".mp2") || filename.endsWith(".ra")) {
	...
	static class ImageFileFilter implements SmbFileFilter {
		public boolean accept(SmbFile arg0) throws SmbException {
			...
			filename = filename.toLowerCase();
			if (arg0.isDirectory() || filename.endsWith(".jpg")
					|| filename.endsWith(".gif") || filename.endsWith(".png")
	...
	public static void writeUserInfo() {
		try {
			SaveUserInfo.writeINIFile(fileName, mNamePWDTable);
		} catch (Exception e) {
			return;
		}
	}
	...
	private void readUserInfo() {
		try {
			SaveUserInfo.readINIFile(fileName, mNamePWDTable);
		} catch (Exception e) {
			return;
		}
	}
	...
	private boolean isValidFilterType(int type) {
		if (type != TYPE_ALL && type != TYPE_VIDEO && type != TYPE_AUDIO
				&& type != TYPE_IMAGE && type != TYPE_TEXT)
			return false;
		return true;
	}
...
//			mNamePWDTable.put(path, new LoginInfo("", ""));
	...
	private SmbFile getSmbFileIns(String path) throws MalformedURLException,
		...
		if (mNamePWDTable.containsKey(path) == true) {
			if(localLOGV)	NetLog.d(taglogin, "[getSmbFileIns]: mNamePWDTable.containsKey(path) ");
			LoginInfo login = mNamePWDTable.get(path);
