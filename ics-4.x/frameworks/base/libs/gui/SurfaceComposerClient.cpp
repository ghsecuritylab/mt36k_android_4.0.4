...
public:
	...
	status_t setComposing3DImpl(DisplayID dpy,int threeD);
	
	static status_t setComposing3D(DisplayID dpy,int threeD){
		return Composer::getInstance().setComposing3DImpl(dpy, threeD);
	}
...
/**add mtk40641*/
status_t Composer::setComposing3DImpl(DisplayID dpy , int threeD){
	
	sp<ISurfaceComposer> sm(getComposerService());
	return sm->setComposing3D(dpy,threeD);
...
/**add mtk40641*/
status_t SurfaceComposerClient::setComposing3D(DisplayID dpy, int threeD)
{
	
	return Composer::setComposing3D(dpy,threeD);
}
