...
public class MimeType {
     ...
     */
    private static MimeType sMimeTypeMap;
...
//        return "";
    ...
    public static String getType(String mimeType) {
    	if (mimeType == null || !mimeType.contains("/"))
    		return null;
    	String[] segments = mimeType.split("/");
    	return segments[0];
    }
    ...
    public static MimeType getSingleton() {
        if (sMimeTypeMap == null) {
            ...
            //sMimeTypeMap.loadEntry("text/texmacs", "ts");	//同视频ts
            ...
            //sMimeTypeMap.loadEntry("video/x-ms-asf", "asx");	//ms801不支持此格式
            ...
            //TCL Add
            //hujb add
            sMimeTypeMap.loadEntry("image/raw", "raw");
            sMimeTypeMap.loadEntry("image/pvr", "pvr");
            sMimeTypeMap.loadEntry("image/tga", "tga");
            sMimeTypeMap.loadEntry("image/mpo", "mpo");
            
            sMimeTypeMap.loadEntry("video/x-flv", "flv");
            sMimeTypeMap.loadEntry("video/mpeg", "m2ts");
            sMimeTypeMap.loadEntry("video/mpeg", "m2p");
            sMimeTypeMap.loadEntry("video/mpeg", "m1v");
            sMimeTypeMap.loadEntry("video/mpeg", "m2v");
            sMimeTypeMap.loadEntry("video/mpeg", "mkv");
            //sMimeTypeMap.loadEntry("video/mpeg", "VOB");
            sMimeTypeMap.loadEntry("video/x-pn-realvideo", "rm");	//rm是音频还是视频？
            sMimeTypeMap.loadEntry("video/x-pn-realvideo", "rmvb");
            
            sMimeTypeMap.loadEntry("video/x-xvid", "xvid");
            //sMimeTypeMap.loadEntry("application/x-shockwave-flash", "SWF");

            sMimeTypeMap.loadEntry("video/mpeg", "m4p");
            sMimeTypeMap.loadEntry("video/mpeg", "m2t");
            sMimeTypeMap.loadEntry("video/mpeg", "dat");
            sMimeTypeMap.loadEntry("video/mpeg", "ts");
            sMimeTypeMap.loadEntry("video/mpeg", "tp");

            sMimeTypeMap.loadEntry("audio/mpeg", "aac");
            sMimeTypeMap.loadEntry("audio/mpeg", "ac3");
            ...
            /*
                      //zhangsh add,20101008 +
                 addFileType("FLV",FILE_TYPE_FLV,"video/x-flv");                
                 
                 addFileType("MPG",FILE_TYPE_MPG,"video/mpeg");
                 addFileType("M2TS",FILE_TYPE_MPG,"video/mpeg");
                 addFileType("M2P",FILE_TYPE_MPG,"video/mpeg");
                 addFileType("M1V",FILE_TYPE_MPG,"video/mpeg");
                 addFileType("M2V",FILE_TYPE_MPG,"video/mpeg");
                 addFileType("VOB",FILE_TYPE_MPG,"video/mpeg");
                 
                 addFileType("XVID",FILE_TYPE_XVID,"video/x-xvid");
                 addFileType("SWF",FILE_TYPE_SWF,"application/x-shockwave-flash");
                 
                 
                 addFileType("M4P",FILE_TYPE_TS,"application/octet-stream");
                 addFileType("M2T",FILE_TYPE_TS,"application/octet-stream");
                 addFileType("DAT",FILE_TYPE_TS,"application/octet-stream");
                 addFileType("TS",FILE_TYPE_TS,"application/octet-stream");
                 addFileType("TP",FILE_TYPE_TS,"application/octet-stream");
                 
                 addFileType("RM",FILE_TYPE_RMVB,"video/x-pn-realvideo");
