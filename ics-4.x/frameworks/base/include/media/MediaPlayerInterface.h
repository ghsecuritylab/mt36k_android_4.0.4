...
public:
    ...
    virtual status_t    setAudioTrack(int track_num){return INVALID_OPERATION;}
    virtual status_t    setSubtitleTrack(int track_num){return INVALID_OPERATION;}
	virtual status_t    setPlaySeamless(bool bIsSeamless){return INVALID_OPERATION;}
    virtual status_t    setExSubtitleURI(const char *url){return INVALID_OPERATION;}    
    virtual status_t    getAudioTrackNs(int *trk_nums) {return INVALID_OPERATION;}
    virtual status_t    getSubtitleTrackNs(int *trk_nums){return INVALID_OPERATION;}
