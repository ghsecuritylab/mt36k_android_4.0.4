...
public:
    ...
    virtual status_t        setAudioTrack(int track_num)= 0;
    virtual status_t        setSubtitleTrack(int track_num)= 0;
	virtual status_t        setPlaySeamless(bool bIsSeamless)= 0;
    virtual status_t        setExSubtitleURI(const char *url) = 0; 
    virtual status_t        getSubtitleTrackNs(int *trk_nums)= 0;
    virtual status_t        getAudioTrackNs(int *trk_nums)= 0 ;
