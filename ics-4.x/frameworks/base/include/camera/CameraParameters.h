...
//added by wang youlin
	void getControlParameterValue(const char* Control,int *Value) const;
	void setControlParameterScope(const char* Control, int ValueNow, int Minimum, int Maximum, int step, int DefaultValue);
    void getInterpolationSize(int *width, int *height) const;
//end by wang youlin
...
//added by wang youlin
	static const char KEY_CONTROL_BRIGHTNESS_SCOPE[];
	static const char KEY_CONTROL_BRIGHTNESS_VALUE[];

	static const char KEY_CONTROL_CONTRAST_SCOPE[];
	static const char KEY_CONTROL_CONTRAST_VALUE[];

	static const char KEY_CONTROL_SATURATION_SCOPE[];
	static const char KEY_CONTROL_SATURATION_VALUE[];

	static const char KEY_CONTROL_SHARPNESS_SCOPE[];
	static const char KEY_CONTROL_SHARPNESS_VALUE[];

	static const char KEY_CONTROL_WHITENESS_SCOPE[];
	static const char KEY_CONTROL_WHITENESS_VALUE[];

	static const char KEY_INTERPOLATION_SIZE[];
//end by wang youlin
