...
public class WritePreloadedClassFile {
     ...
     */
    // static final int MIN_LOAD_TIME_MICROS = 0; /* ori: 1250 */
    // modified by mtk
    static int MIN_LOAD_TIME_MICROS = 1250;
    

    /**
     * Preload any class that was loaded by at least MIN_PROCESSES processes.
     */
    // static final int MIN_PROCESSES = 0; /* ori: 10 */
    // modified by mtk
    static int MIN_PROCESSES = 10;
    ...
    public static void main(String[] args) throws IOException,
        ...
        */
		/* modified by mtk: start */
		if (args.length != 1 && args.length != 3) {
			System.err.println("Usage1: java WritePreloadedClassFile [compiled log]");
			System.err.println("Usage2: java WritePreloadedClassFile [compiled log] [MIN_LOAD_TIME_MICROS] [MIN_PROCESSES]");
			System.err.println("\t ex: java WritePreloadedClassFile logcat.compiled 0 0");
			System.exit(-1);
		}

		if (args.length == 3)
		{
			MIN_LOAD_TIME_MICROS = Integer.parseInt(args[1]);
			MIN_PROCESSES = Integer.parseInt(args[2]);
		}
		System.out.println("MIN_LOAD_TIME_MICROS = " + MIN_LOAD_TIME_MICROS + ", MIN_PROCESSES = " + MIN_PROCESSES);
		/* modified by mtk: end */
