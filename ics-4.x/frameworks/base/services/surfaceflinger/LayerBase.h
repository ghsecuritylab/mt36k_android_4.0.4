...
protected:
    const GraphicPlane& graphicPlane(int dpy) const;
		  ...
		  //40641
		  void drawNormal(const Region& clip ,uint32_t fbHeight ,uint8_t type ) const;
		  void drawTopAndBottom(const Region& clip ,uint32_t fbHeight ,uint8_t eType ) const;
		  void drawSideBySide(const Region& clip ,uint32_t hw_w_half ,uint32_t fbHeight ,uint8_t eType ) const;
