...
public:
    static status_t orientationToTransfrom(int orientation, int w, int h,
		...
		/**add mtk40641*/
		status_t				setComposing3D(uint32_t layer_type);
		//
...
enum {
    ...
    eComposing3DLeft        = 0x01,
    eComposing3DRight       = 0x02,
    eComposing3DTop         = 0x03,
    eComposing3DBottom      = 0x04,
};
enum {   
    eSTEREO_OSD_3D_NONE = 0x00, 	
	eSTEREO_OSD_3D_SBSHALFE_PR= 0x01,
	eSTEREO_OSD_3D_TPANDBT_PR= 0x02,
	eSTEREO_OSD_3D_SBSHALFE_SG= 0x03,
	eSTEREO_OSD_3D_TPANDBT_SG= 0x04,
};
...
/**add mtk40641*/
virtual status_t				   setComposing3D(DisplayID dpy = 0, int threeD = 0);
   virtual int 					   isComposing3D() const { return mDrawingState.composing3D;}
...
private:
    ...
    struct State {
        State() {
			...
			/**add mtk40641*/
			composing3D = eSTEREO_OSD_3D_NONE;
			composingPass = eComposingNormal;
			//
        }
...
//mtk40641
   const       State&                      getDrawingState() { return mDrawingState; };
};
