...
static void android_server_InputManager_nativeDisablePointer(JNIEnv* env,jclass clazz) {
           //gNativeInputManager->bEnablePointer = false;
          LOGD("======== ========lizhyuan ====android_server_InputManager_nativeDisablePointer=====");
           gNativeInputManager->getInputManager()->getReader()->setPointerState(true);
           
}
 
static void android_server_inputManager_nativeEnablePointer(JNIEnv* env,jclass clazz) {
 
                 //gNative/InputManager->bEnablePointer = true;
          LOGD("======== ========lizhyuan ====android_server_inputManager_nativeEnablePointer=====");
                 gNativeInputManager->getInputManager()->getReader()->setPointerState(false);
}
