...
//            }
        ...
        if (factoryTest != SystemServer.FACTORY_TEST_LOW_LEVEL) {
           ...
           try {
            ...
            try {
                Slog.i(TAG, "UvcCameraObserver");
                // Listen for wired headset changes
                camera  = new UvcCameraObserver(context);
            } catch (Throwable e) {
                Slog.e(TAG, "Failure starting UvcCameraObserver", e);
            }
...
public class SystemServer {
    ...
    public static void main(String[] args) {
        ...
        VMRuntime.getRuntime().setTargetHeapUtilization(/*0.8f*/0.95f);
