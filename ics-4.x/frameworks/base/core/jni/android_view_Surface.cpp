...
static void Surface_setComposing3D(
        JNIEnv* env, jobject clazz, jint display, jint enable)
{
    LOGE("JNI Surface_setComposing3D ***********STARS**************");
    int err = SurfaceComposerClient::setComposing3D(display, enable);
    if (err < 0) {
...
static JNINativeMethod gSurfaceMethods[] = {
    ...
    {"setComposing3D",		"(II)V", (void*)Surface_setComposing3D },	
