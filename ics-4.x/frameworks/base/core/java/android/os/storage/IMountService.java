    ...
    public static abstract class Stub extends Binder implements IMountService {
        private static class Proxy implements IMountService {
            ...
            public String getVolumeLabel(String mountPoint) throws RemoteException {
                ...
                //re_result = _result.trim();//Remove all leading whitespace and trailing whitespace characters from the current String object.
                //return re_result;
                return _result;
            }
	  ...
	  static final int TRANSACTION_getVolumeUuid = IBinder.FIRST_CALL_TRANSACTION + 34;
