...
public class Surface implements Parcelable {
	...
	/**  set compose3D layer
		phy:				should be set as 0 in TV;
		compose3D: 		Default is WindowManager.LayoutParams.STEREO_OSD_3D_NONE
		can be set as:
		WindowManager.LayoutParams.STEREO_OSD_3D_NONE
		WindowManager.LayoutParams.STEREO_OSD_3D_SBSHALFE_PR   SideBySide
		WindowManager.LayoutParams.STEREO_OSD_3D_TPANDBT_PR	TopAndBottom	
		
	*	
	*
	*/
	//40641
	public static native   void setComposing3D(int phy, int compose3D);
