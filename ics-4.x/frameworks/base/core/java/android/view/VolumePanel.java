...
public class VolumePanel extends Handler implements OnSeekBarChangeListener, View.OnClickListener
{
    ...
    private void createSliders() {
        ...
        for (int i = 0; i < STREAMS.length; i++) {
            ...
            //add by liust
            sc.text = (TextView) sc.group.findViewById(R.id.volumes);
            sc.text.setTag(sc);
    ...
    private void updateSlider(StreamControl sc) {
        ...
        sc.text.setText(String.valueOf(mAudioManager.getLastAudibleStreamVolume(sc.streamType)));
...
//                setRingerIcon();
        ...
        if (sc != null) {
            ...
            sc.text.setText(String.valueOf(index));
        }
