...
public class KeyEvent extends InputEvent implements Parcelable {
    ...
    //add by lulin for function of 3D and Information windows start 
    
    public static final int KEYCODE_TCL_Information_Windows  = 401;    // NOTE: If you add a new keycode here you must also add it to:
    public static final int KEYCODE_TCL_FASTMOVE_LEFT_1 = 402;
    public static final int KEYCODE_TCL_FASTMOVE_LEFT_2 = 403;
    public static final int KEYCODE_TCL_FASTMOVE_LEFT_3 = 404;
    public static final int KEYCODE_TCL_FASTMOVE_LEFT_4 = 405;
    public static final int KEYCODE_TCL_FASTMOVE_RIGHT_1 = 406;
    public static final int KEYCODE_TCL_FASTMOVE_RIGHT_2 = 407;
    public static final int KEYCODE_TCL_FASTMOVE_RIGHT_3 = 408;
    public static final int KEYCODE_TCL_FASTMOVE_RIGHT_4 = 409;
    public static final int KEYCODE_TCL_3D          = 410;
    public static final int KEYCODE_TCL_FAC_IR          = 411;
    public static final int KEYCODE_TCL_IR_HOT_ON_END= 414; // 0x19e
	public static final int KEYCODE_TCL_IR_HOT_OFF = 413; // 0x19d
    public static final int KEYCODE_TCL_IR_HOT_ON = 412; // 0x19c

//add by lulin for function of 3D and Information windows end
    private static final int LAST_KEYCODE           = KEYCODE_MTKIR_BLUE;
