...
interface IWindowManager
{
    ...
    boolean isFocusTV();    
    void setPowerOff(boolean bPowerOff);
    boolean isPowerOff();
    //End by TCL
...
/***********modify by lizhyuan for mouse end*********************/
   ...
   //start set home key pengpai@2016.1.20
    ...
    void setEnableHomeKey(boolean bEnableHomeKey);
    
    boolean getEnableHomeKey();
    
    long getTimeOfDisableHomeKey();
