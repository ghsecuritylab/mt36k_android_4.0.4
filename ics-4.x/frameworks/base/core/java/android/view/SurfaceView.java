...
public class SurfaceView extends View {
	...
	/**  set View as 3D layer				
		flag: 		Default is WindowManager.LayoutParams.LAYOUT3D_DISABLED
		can be set as:
		WindowManager.LayoutParams.LAYOUT3D_DISABLED
		WindowManager.LayoutParams.LAYOUT3D_SIDE_BY_SIDE   SideBySide
		WindowManager.LayoutParams.LAYOUT3D_TOP_AND_BOTTOM	TopAndBottom	
	...
	*/
	//mtk 40641
		public void set3DLayout(int flag) {
				Log.i(TAG, "Surface view set3DLayout");
				m3DLayoutFlag = flag;
				Log.i(TAG, "Surface view set3DLayout: " + m3DLayoutFlag);
        ...
        if (force || creating || formatChanged || sizeChanged || visibleChanged
            ...
            try {
				...
				// set 3D layout 
							  ...
							  Log.i(TAG, "update window set3DLayout: " + mLayout.layout3D); 
