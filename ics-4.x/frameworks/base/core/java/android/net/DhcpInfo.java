...
public class DhcpInfo implements Parcelable {
	...
	public String getGateWayValue(){
		return NetworkUtils.intToInetAddress(gateway).getHostAddress();
	...
	public String getDNS1Value(){
		return NetworkUtils.intToInetAddress(dns1).getHostAddress();

	}

			
	public String getDNS2Value(){
		return NetworkUtils.intToInetAddress(dns2).getHostAddress();
