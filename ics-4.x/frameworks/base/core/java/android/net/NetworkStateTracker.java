...
public interface NetworkStateTracker {
    ...
    public static final int EVENT_ADSL_CONNECTED = 8;//add for adsl interface up event--HQS
    public static final int EVENT_ADSL_AUTHFAIL = 9;//add for adsl fail event--HQS
    public static final int EVENT_ETH_ABNORMAL = 10;
