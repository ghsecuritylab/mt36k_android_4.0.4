...
public class Intent implements Parcelable, Cloneable {
   ...
   /**
     ...
     */
    @SdkConstant(SdkConstantType.BROADCAST_INTENT_ACTION)
    public static final String ACTION_HOME_PRESS =
            "android.intent.action.HOME_PRESS";

	
     /**
     * Broadcast Action: WIDGET_SWITCHER
     *
     * <p>The intent will have the following extra values:
     * <ul>
     */
    @SdkConstant(SdkConstantType.BROADCAST_INTENT_ACTION)
    public static final String ACTION_POWEROFF_NOTIFY =
            "android.intent.action.POWEROFF_NOTIFY";
     ...
     */
    @SdkConstant(SdkConstantType.BROADCAST_INTENT_ACTION)
    public static final String ACTION_APP_WIDGET_SWITCHER =
            "android.intent.action.APP_WIDGET_SWITCHER";
		
/**
     * Broadcast Action: UVC to Usb plugged in or unplugged.
     *
     * <p>The intent will have the following extra values:
     * <ul>
     *   <li><em>state</em> - 0 for unplugged, 1 for plugged. </li>
     *   <li><em>name</em> - UVC type, human readable string </li>
     * 
     * </ul>
     * </ul>
     */
    @SdkConstant(SdkConstantType.BROADCAST_INTENT_ACTION)
    public static final String ACTION_UVCCAM_PLUG =
            "android.intent.action.UVCCAM_PLUG";
    /**
     * Broadcast Action: An analog audio speaker/headset plugged in or unplugged.
     *
     * <p>The intent will have the following extra values:
...
/**
     * Broadcast Action: Volume Up Key
     *
     * <p>The intent will have the following extra values:
     */
    @SdkConstant(SdkConstantType.BROADCAST_INTENT_ACTION)
    public static final String ACTION_KEYCODE_VOLUME_UP =
            "android.intent.action.KEYCODE_VOLUME_UP";

/**
     * Broadcast Action: Volume Down Key
     *
     * <p>The intent will have the following extra values:
     */
    @SdkConstant(SdkConstantType.BROADCAST_INTENT_ACTION)
    public static final String ACTION_KEYCODE_VOLUME_DOWN =
            "android.intent.action.KEYCODE_VOLUME_DOWN";


/**
     * Broadcast Action: Volume Mute Key
     *
     * <p>The intent will have the following extra values:
     */
    @SdkConstant(SdkConstantType.BROADCAST_INTENT_ACTION)
    public static final String ACTION_KEYCODE_MUTE =
            "android.intent.action.KEYCODE_MUTE";
