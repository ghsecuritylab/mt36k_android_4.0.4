...
public final class Configuration implements Parcelable, Comparable<Configuration> {
    ...
    public int diff(Configuration delta) {
        ...
        if (delta.keyboard != KEYBOARD_UNDEFINED
                && keyboard != delta.keyboard) {
            //changed |= ActivityInfo.CONFIG_KEYBOARD;
          //    Slog.i("Configuration.diff", "keyboard" +  Integer.toHexString(delta.keyboard) + "    " +  Integer.toHexString(keyboard));
        }
        if (delta.keyboardHidden != KEYBOARDHIDDEN_UNDEFINED
                && keyboardHidden != delta.keyboardHidden) {
           // changed |= ActivityInfo.CONFIG_KEYBOARD_HIDDEN;
        //   Slog.i("Configuration.diff", "keyboardHidden" +  Integer.toHexString(delta.keyboardHidden) + "    " +  Integer.toHexString(keyboardHidden));
        }
        if (delta.hardKeyboardHidden != HARDKEYBOARDHIDDEN_UNDEFINED
                && hardKeyboardHidden != delta.hardKeyboardHidden) {
          //  changed |= ActivityInfo.CONFIG_KEYBOARD_HIDDEN;
         // Slog.i("Configuration.diff", "hardKeyboardHidden" +  Integer.toHexString(delta.hardKeyboardHidden) + "    " +  Integer.toHexString(hardKeyboardHidden));
        }
        if (delta.navigation != NAVIGATION_UNDEFINED
                && navigation != delta.navigation) {
            changed |= ActivityInfo.CONFIG_NAVIGATION;
