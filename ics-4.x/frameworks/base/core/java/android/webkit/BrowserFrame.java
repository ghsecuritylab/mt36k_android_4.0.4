...
class BrowserFrame extends Handler {
    ...
    public BrowserFrame(Context context, WebViewCore w, CallbackProxy proxy,
        ...
        if (sJavaBridge == null) {
            ...
            if (am.getMemoryClass() > 16 && (1 != mtkCachePolicy)) {
                sJavaBridge.setCacheSize(8 * 1024 * 1024);
                Log.v(LOGTAG, "Set cache size to 8 MB");
            } else {
                sJavaBridge.setCacheSize(4 * 1024 * 1024);
                Log.v(LOGTAG, "Set cache size to 4 MB");
            }
            // -- MTK_WEBKIT_FIX END --
    ...
    // -- MTK_WEBKIT_FIX START --
    public native void clearCache(boolean includeDiskFiles);
    // -- MTK_WEBKIT_FIX END --
