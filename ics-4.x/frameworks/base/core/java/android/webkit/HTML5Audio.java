...
class HTML5Audio extends Handler
            ...
            case TIMEUPDATE: {
                try {
                    if (mState != ERROR && mMediaPlayer.isPlaying()) {
                        ...
                        // -- MTK_WEBKIT_FIX START --
                        Log.i(LOGTAG, "To call nativeOnTimeupdate(), position: " + position +
    ...
    public void onBufferingUpdate(MediaPlayer mp, int percent) {
        // -- MTK_WEBKIT_FIX START --
        Log.e(LOGTAG, "To call onBufferingUpdate()");
        // -- MTK_WEBKIT_FIX END --
    ...
    public void onCompletion(MediaPlayer mp) {
        ...
        mState = IDLE;
        // -- MTK_WEBKIT_FIX START --
        Log.i(LOGTAG, "Enter onCompletion()");
        // -- MTK_WEBKIT_FIX END --
    ...
    public void onPrepared(MediaPlayer mp) {
        ...
        // -- MTK_WEBKIT_FIX START --
        Log.e(LOGTAG, "To call nativeOnPrepared(), position: " + mp.getDuration() +
                                                  ", mNativePointer = " + mNativePointer);
        // -- MTK_WEBKIT_FIX END --
    ...
    public void onSeekComplete(MediaPlayer mp) {
        // -- MTK_WEBKIT_FIX START --
        Log.i(LOGTAG, "Enter onSeekComplete()");
        Log.i(LOGTAG, "To call nativeOnTimeupdate(), position: " + mp.getDuration() +
                                                  ", mNativePointer = " + mNativePointer);
        // -- MTK_WEBKIT_FIX END --
    ...
    public HTML5Audio(WebViewCore webViewCore, int nativePtr) {
        ...
        // -- MTK_WEBKIT_FIX START --
        mWebView = webViewCore.getWebView();
        // -- MTK_WEBKIT_FIX END --
    }

    private void resetMediaPlayer() {
        Log.i(LOGTAG, "Enter resetMediaPlayer()");
    ...
    private void setDataSource(String url) {
        ...
        if (useCmpbPlayer == 1 && url.startsWith("http") && mWebView != null && mWebView.getSettings() != null && (-1 == url.indexOf("?mtkUAString=")))
        {
            url += "?mtkUAString=";
            url += mWebView.getSettings().getUserAgentString();
        }

        Log.e(LOGTAG, "Enter setDataSource(), URL = " + url);
        // -- MTK_WEBKIT_FIX END --
        ...
        try {
            ...
            Log.i(LOGTAG, "couldn't load the resource: "+ debugUrl +" exc: " + e);
            resetMediaPlayer();
        }
    }
    ...
    private void play() {
        // -- MTK_WEBKIT_FIX START --
        Log.i(LOGTAG, "Enter play(), mState = " + mState);
        // -- MTK_WEBKIT_FIX END --
    ...
    private void pause() {
        // -- MTK_WEBKIT_FIX START --
        Log.i(LOGTAG, "Enter pause(), mState = " + mState);
        // -- MTK_WEBKIT_FIX END --
    ...
    private void seek(int msec) {
        // -- MTK_WEBKIT_FIX START --
        Log.i(LOGTAG, "Enter seek(), msec = " + msec);
        // -- MTK_WEBKIT_FIX END --
    ...
    private void teardown() {
        // -- MTK_WEBKIT_FIX START --
        Log.i(LOGTAG, "Enter teardown(), mState = " + mState);
        // -- MTK_WEBKIT_FIX END --
