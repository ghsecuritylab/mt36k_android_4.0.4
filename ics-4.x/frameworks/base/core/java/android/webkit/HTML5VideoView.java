...
public class HTML5VideoView implements MediaPlayer.OnPreparedListener {
    ...
    public void start() {
        Log.e(LOGTAG, "Enter start(), mCurrentState() = " + mCurrentState);
        ...
        // -- MTK_WEBKIT_FIX START --
        // enable the auto start flag
        else
            mAutostart = true;
        // -- MTK_WEBKIT_FIX END --

        Log.e(LOGTAG, "Exit start()");
    }

    public void pause() {
        Log.e(LOGTAG, "Enter pause(), isPlaying() = " + isPlaying());
        ...
        Log.e(LOGTAG, "Exit pause()");
    }

    public int getDuration() {
        if (mCurrentState == STATE_PREPARED) {
            Log.e(LOGTAG, "Enter getDuration(), Duration() = " + mPlayer.getDuration());

            return mPlayer.getDuration();
        } else {
            Log.e(LOGTAG, "Enter getDuration(), Duration() = -1");
    ...
    public void seekTo(int pos) {
        Log.e(LOGTAG, "Enter seekTo(), pos = " + pos + "; mCurrentState = " + mCurrentState);
    ...
    public void release() {
        Log.e(LOGTAG, "Enter release(), mCurrentState() = " + mCurrentState);
        ...
        Log.e(LOGTAG, "Exit release()");
    }

    public void stopPlayback() {
        Log.e(LOGTAG, "Enter stopPlayback(), mCurrentState() = " + mCurrentState);

        if (mCurrentState == STATE_PREPARED) {
            mPlayer.stop();
        }

        Log.e(LOGTAG, "Exit stopPlayback()");
    }
    ...
    public void onPrepared(MediaPlayer mp) {
    	Log.d(LOGTAG, "xxh onPrepared  view " + this + " mCurrentState=" + mCurrentState);
    ...
    // -- MTK_WEBKIT_FIX START --
    public void setVideoRect(Rect video_rect) {
        // Only meaningful for HTML5VideoInline
    }
    // -- MTK_WEBKIT_FIX END --
}
