...
//change to 25 seconds, hack by zhipeng.dong
const static int64_t kBufferFilledEventTimeOutNs = 25000000000LL;
...
//    { MEDIA_MIMETYPE_AUDIO_AAC, "OMX.Nvidia.aac.decoder" },
    ...
    { MEDIA_MIMETYPE_VIDEO_H263, "OMX.MTK.Video.Decoder.MPEG4" },
    ...
    { MEDIA_MIMETYPE_VIDEO_AVC, "OMX.MTK.Video.Decoder.H264" },
...
//hack by zhipeng.dong, these decoders don't work
...
uint32_t OMXCodec::getComponentQuirks(
    ...
    /*added by alex, because our component need be flush before stop. */
    /*but kRequiresAllocateBufferOnInputPorts and kRequiresAllocateBufferOnOutputPorts need be checked*/
    if(!strcmp(componentName, "OMX.MTK.Video.Decoder.MPEG4"))
    {
        quirks |= kRequiresAllocateBufferOnInputPorts;
        quirks |= kRequiresAllocateBufferOnOutputPorts;
        ...
        LOGI("OMX.MTK.VIDEO.Decoder.MPEG4 get quirks=%d\n", quirks);
    }
    if(!strcmp(componentName, "OMX.MTK.Video.Decoder.H264"))
    {
        quirks |= kRequiresAllocateBufferOnInputPorts;
        quirks |= kRequiresAllocateBufferOnOutputPorts;
        quirks |= kRequiresFlushBeforeShutdown;
        ...
        LOGI("OMX.MTK.VIDEO.Decoder.H264 get quirks=%d\n", quirks);   
...
status_t OMXCodec::configureCodec(const sp<MetaData> &meta) {
    ...
    if (!strcasecmp(MEDIA_MIMETYPE_AUDIO_AMR_NB, mMIME)) {
...
#ifndef ANDROID_DEFAULT_CODE //2012/5/9 by Daniel, Fix wav file a-law/u-law not 8KHz playback problem.
        ...
        errG711 = mOMX->getParameter(mNode, OMX_IndexParamAudioPcm, &profileG711, sizeof(profileG711));
        ...
        errG711 = mOMX->setParameter(mNode, OMX_IndexParamAudioPcm, &profileG711, sizeof(profileG711));
        if (errG711 != OK) 
        {
            LOGE("setG711Format() failed (errG711 = %d)", errG711);
            return errG711;
        }
#else
        int32_t numChannels;
...
status_t OMXCodec::setVideoOutputFormat(
...
#if 1
    {
        ...
        //zink format.eColorFormat = OMX_COLOR_FormatYUV420Planar;//OMX_COLOR_Format32bitARGB8888;
        //format.eColorFormat = OMX_COLOR_Format32bitARGB8888; //zink
        format.eColorFormat = OMX_COLOR_FormatYUV420Planar; //zink
        //format.eColorFormat = OMX_COLOR_FormatYUV420SemiPlanar;
...
status_t OMXCodec::allocateOutputBuffersFromNativeWindow() {
    ...
    err = native_window_set_buffers_geometry(
            ...
            //zink def.format.video.eColorFormat);
...
void OMXCodec::on_message(const omx_message &msg) {
    ...
    switch (msg.type) {
        ...
        {
           //Mutex::Autolock autoLock(mEmptyLock);
