...
public:
    ...
    {
        LOGE("IMediaPlayer::setVideoRect(%d,%d, %d, %d)", i4left, i4top, i4right, bottom);
        Parcel data, reply;
        data.writeInterfaceToken(IMediaPlayer::getInterfaceDescriptor());
    ...
    status_t setAudioTrack(int track_num)
    {
        LOGE("IMediaPlayer::setAudioTrack(%d)", track_num);
        Parcel data, reply;
        data.writeInterfaceToken(IMediaPlayer::getInterfaceDescriptor());
        data.writeInt32(track_num);
        remote()->transact(SET_AUDIO_TRACK, data, &reply);
        return reply.readInt32();
    }
     
    status_t setSubtitleTrack(int track_num)
    {
        LOGE("IMediaPlayer::setSubtitleTrack(%d)", track_num);
        Parcel data, reply;
        data.writeInterfaceToken(IMediaPlayer::getInterfaceDescriptor());
        data.writeInt32(track_num);
        remote()->transact(SET_SUBTT_TRACK, data, &reply);
        return reply.readInt32();
    }
	status_t setPlaySeamless(bool bIsSeamless)
    {
        LOGE("IMediaPlayer::setSeamless");
        Parcel data, reply;
        data.writeInterfaceToken(IMediaPlayer::getInterfaceDescriptor());
        data.writeInt32((int)bIsSeamless);
        remote()->transact(SET_PLAY_SEAMLESS, data, &reply);
        return reply.readInt32();
    }
    status_t setExSubtitleURI(const char *url)
    {
        LOGE("IMediaPlayer::setExSubtitleURI(%s)", url);
        Parcel data, reply;
        data.writeInterfaceToken(IMediaPlayer::getInterfaceDescriptor());
        data.writeCString(url);
        remote()->transact(SET_EX_SUBTT_URI, data, &reply);
        return reply.readInt32();
    }

    
    status_t getSubtitleTrackNs(int* track_num)
    {
        Parcel data, reply;
        data.writeInterfaceToken(IMediaPlayer::getInterfaceDescriptor());
        remote()->transact(GET_SUBTT_NUMS, data, &reply);
        *track_num = reply.readInt32();
        LOGE("IMediaPlayer::getSubtitleTrackNs(%d)", track_num);        
        return reply.readInt32();
    }
    
    status_t getAudioTrackNs(int* track_num)
    {
        Parcel data, reply;
        data.writeInterfaceToken(IMediaPlayer::getInterfaceDescriptor());
        remote()->transact(GET_AUDIO_NUMS, data, &reply);
        *track_num = reply.readInt32();
        LOGE("IMediaPlayer::getAudioTrackNs(%d)", track_num);
        return reply.readInt32();
    } 
    ...
    uint32_t code, const Parcel& data, Parcel* reply, uint32_t flags)
{
    switch(code) {
        ...
        case SET_DISP_RECT: {
            #if 1
            CHECK_INTERFACE(IMediaPlayer, data, reply);
            LOGI("BnMediaPlayer::onTransact(case SET_DISP_RECT)");
        ...
        case SET_SUBTT_TRACK: {
            CHECK_INTERFACE(IMediaPlayer, data, reply);
            reply->writeInt32(setSubtitleTrack(data.readInt32()));
            return NO_ERROR;
        }break;     
		case SET_PLAY_SEAMLESS: {
			CHECK_INTERFACE(IMediaPlayer, data, reply);
            reply->writeInt32(setPlaySeamless((bool)data.readInt32()));
            return NO_ERROR;
        }break;        
        case SET_EX_SUBTT_URI: {
            CHECK_INTERFACE(IMediaPlayer, data, reply);
            reply->writeInt32(setExSubtitleURI(data.readCString()));
            return NO_ERROR;
        }break;        
        case GET_SUBTT_NUMS: {
            CHECK_INTERFACE(IMediaPlayer, data, reply);
            int subtt_ns;
            status_t ret = getSubtitleTrackNs(&subtt_ns);
            reply->writeInt32(subtt_ns);
            reply->writeInt32(ret);
            return NO_ERROR;
        }break;
        case GET_AUDIO_NUMS: {
            CHECK_INTERFACE(IMediaPlayer, data, reply);
            int audio_ns;
            status_t ret = getAudioTrackNs(&audio_ns);
            reply->writeInt32(audio_ns);
            reply->writeInt32(ret);
