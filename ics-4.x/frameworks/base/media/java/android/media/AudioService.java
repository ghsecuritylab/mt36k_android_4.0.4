...
public class AudioService extends IAudioService.Stub {
    ...
    */
    ...
    public void adjustStreamVolume(int streamType, int direction, int flags) {
      	...
      	Log.d(TAG, ">>> davild>>>>>>>>>>> Entry adjustStreamVolume !!! ");
    	int curVol = getStreamVolume(streamType);
	

	if(direction == 1)
		setMuteUI(false);	

	if( (curVol==1)&& (direction == -1 ) )
		setMuteUI(true);
	

	Log.d(TAG, ">>> davild>>>>>>>>>>> Entry adjustStreamVolume  curVol:  "+ curVol );
      	Log.d(TAG, ">>> davild>>>>>>>>>>> Entry adjustStreamVolume  directtion:  "+ direction  );
    ...
    // UI update and Broadcast Intent - Volume
    private void sendVolumeUpdate(int streamType, int oldIndex, int index, int flags) {
     ...
     if(!((isStreamMute(streamType))&&(oldIndex-index>0)))
		{
    ...
    public void setStreamMute(int streamType, boolean state, IBinder cb) {
        ...
        //if(isStreamMute(streamType))
       	{       	
		  adjustStreamVolume(streamType, 0, 0);
       	}
