...
public class MediaPlayer
{
    ...
    private native void _setVideoRect(int left, int top, int right, int bottom);
    ...
    public void setDisplay(SurfaceHolder sh) {
        ...
        _setVideoRect(rect.left, rect.top, rect.right, rect.bottom);
        updateSurfaceScreenOn();
    }

    // -- MTK_WEBKIT_FIX START --
    /**
     * Set video display rectangle
     *
    ...
    private class EventHandler extends Handler
    {
        ...
        public void handleMessage(Message msg) {
            ...
            case MEDIA_SET_VIDEO_SIZE:
			  ...
			  Rect rect;
        	  try {
            	    rect = HolderSourceManager.getInstance().get(mSurfaceHolder);
        	  		} catch (Exception e) {
            		e.printStackTrace();
            		rect = mSurfaceHolder.getSurfaceFrame();
        		}
        	  Log.v(TAG, "MEDIA_SET_VIDEO_SIZE in Abs Rect " + rect);
        	  _setVideoRect(rect.left, rect.top, rect.right, rect.bottom);  
              return;
    ...
    /*MTK Extern APIs*/   
    public native int _getAudioTrackNs();
    public native int _getSubtitleTrackNs();
    /**
     ...
     *        
     */
    public native void _setAudioTrack(short audioTrack);
    /**
     ...
     *        
     */
    public native void _setSubtitleTrack(short subtitleTrack);
    /**
     * Selects an subtitle track to display.
     * 
     * @param path
     ...
     *        
    */
    public native void setExtSubtitleURI(String path) throws IOException, IllegalArgumentException, IllegalStateException;


     /**
          * decide seamless play or not.
          * 
          * @param 
isSeamless
          * when is seamless, value be set to true, else false. 
          *        
          */
    public native  void _setPlaySeamless(boolean isSeamless);
