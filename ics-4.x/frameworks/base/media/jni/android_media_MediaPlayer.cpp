...
android_media_MediaPlayer_setVideoRect(JNIEnv *env, jobject thiz, jint left, jint top, jint right, jint bottom)
{
    ...
    mp->setVideoRect(left, top, right, bottom);
}
...
static void android_media_MediaPlayer_SetAudioTrack (JNIEnv * env, jobject thiz, jshort audioTrack)
{
    sp<MediaPlayer> mp = getMediaPlayer(env, thiz);
    if (mp == NULL ) {
        jniThrowException(env, "java/lang/IllegalStateException", NULL);
    ...
    LOGE("_nativeSetAudioTrack: %d()", audioTrack);
    process_media_player_call( env, thiz, mp->setAudioTrack(audioTrack), NULL, NULL );    
}


static void android_media_MediaPlayer_SetSubtitleTrack (JNIEnv * env, jobject thiz, jshort subtitleTrack)
{
    sp<MediaPlayer> mp = getMediaPlayer(env, thiz);
    if (mp == NULL ) {
        jniThrowException(env, "java/lang/IllegalStateException", NULL);
    ...
    LOGE("_nativeSetSubtitleTrack: %d()", subtitleTrack);
    process_media_player_call( env, thiz, mp->setSubtitleTrack(subtitleTrack), NULL, NULL );
}

static void android_media_MediaPlayer_setPlaySeamless(JNIEnv * env, jobject thiz, jboolean bIsSeamless)
{
	sp<MediaPlayer> mp = getMediaPlayer(env, thiz);
    if (mp == NULL ) {
        jniThrowException(env, "java/lang/IllegalStateException", NULL);
    ...
    LOGE("_nativeSetSeamless: %d()");
    process_media_player_call( env, thiz, mp->setPlaySeamless(bIsSeamless), NULL, NULL );
}

static void
android_media_MediaPlayer_SetExtSubtitleURI(JNIEnv *env, jobject thiz, jstring path)
{
    ...
    LOGE("SetExtSubtitleURI: path %s", pathStr);
    status_t opStatus =
        mp->setExSubtitleURI(
                String8(pathStr));
    ...
    process_media_player_call(
            env, thiz, opStatus, "java/io/IOException",
            "SetExtSubtitleURI failed." );
}


static int
android_media_MediaPlayer_getAudioTrackNs(JNIEnv *env, jobject thiz)
{
    sp<MediaPlayer> mp = getMediaPlayer(env, thiz);
    if (mp == NULL ) {
        jniThrowException(env, "java/lang/IllegalStateException", NULL);
    ...
    int track_num;
    process_media_player_call( env, thiz, mp->getAudioTrackNs(&track_num), NULL, NULL );
    LOGE("getAudioTrackNs: %d (msec)", track_num);
    return track_num;
}

static int
android_media_MediaPlayer_getSubtitleTrackNs(JNIEnv *env, jobject thiz)
{
    sp<MediaPlayer> mp = getMediaPlayer(env, thiz);
    if (mp == NULL ) {
        jniThrowException(env, "java/lang/IllegalStateException", NULL);
    ...
    int track_num;
    process_media_player_call( env, thiz, mp->getSubtitleTrackNs(&track_num), NULL, NULL );
    LOGE("getSubtitleTrackNs: %d (msec)", track_num);
    return track_num;
}
static void
...
static JNINativeMethod gMethods[] = {
    ...
    {"_setVideoRect",       "(IIII)V",                          (void *)android_media_MediaPlayer_setVideoRect},
    {"_setVideoSurface",    "(Landroid/view/Surface;)V",        (void *)android_media_MediaPlayer_setVideoSurface},
    {"setExtSubtitleURI",  "(Ljava/lang/String;)V",            (void *)android_media_MediaPlayer_SetExtSubtitleURI},            
    //{"_setVideoSurface",    "(IIII)V",                              (void *)android_media_MediaPlayer_setVideoSurface},
    {"_setAudioTrack",      "(S)V",                              (void *)android_media_MediaPlayer_SetAudioTrack},
    {"_setSubtitleTrack",   "(S)V",                              (void *)android_media_MediaPlayer_SetSubtitleTrack},    
    {"_setPlaySeamless", 	"(Z)V",								(void *)android_media_MediaPlayer_setPlaySeamless},							
    {"_getSubtitleTrackNs", "()I",                              (void *)android_media_MediaPlayer_getSubtitleTrackNs},
    {"_getAudioTrackNs",    "()I",                              (void *)android_media_MediaPlayer_getAudioTrackNs},    
