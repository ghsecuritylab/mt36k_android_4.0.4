...
public class WifiNative {
    ...
    public native static boolean stopP2pSupplicant();

    /* Sends a kill signal to supplicant. To be used when we have lost connection
       or when the supplicant is hung */
    public native static boolean killSupplicant();

    public native static boolean killP2pSupplicant();

    public native static boolean connectToSupplicant();

    public native static boolean connectToP2pSupplicant();

    public native static void closeSupplicantConnection();
	
    public native static void closeP2pSupplicantConnection();
    ...
    */
    ...
    public native static int getDeviceNum();
    ...
    public native static String getCurrentBss();
        
    public native static boolean removeNetworkCommandAll();
    ...
    public native static String waitForP2pEvent();
    ...
    private native static boolean doP2pBooleanCommand(String command);

    private native static int doIntCommand(String command);
	
    private native static int doP2pIntCommand(String command);

    private native static String doStringCommand(String command);
	public native static void wifiStartDhcpd();
	
	private native static String doP2pStringCommand(String command);
	public native static void wifiStopDhcpd();	
    ...
    public static boolean P2pwpsPbc() {
        return doP2pBooleanCommand("WPS_PBC");
    }

    public static boolean P2pwpsPin(String pin) {
        return doP2pBooleanCommand("WPS_PIN any " + pin);
    }

    public static boolean setPersistentReconnect(boolean enabled) {
        int value = (enabled == true) ? 1 : 0;
        return WifiNative.doP2pBooleanCommand("SET persistent_reconnect " + value);
    }

    public static boolean setDeviceName(String name) {
        return WifiNative.doP2pBooleanCommand("SET device_name " + name);
    }

    public static boolean setDeviceType(String type) {
        return WifiNative.doP2pBooleanCommand("SET device_type " + type);
    }

    public static boolean p2pFind() {
        return doP2pBooleanCommand("P2P_FIND");
    }
    ...
    public static boolean p2pFind(int timeout) {
        ...
        return doP2pBooleanCommand("P2P_FIND " + timeout);
    }

    public static boolean p2pListen() {
        return doP2pBooleanCommand("P2P_LISTEN");
    }
    ...
    public static boolean p2pListen(int timeout) {
        ...
        return doP2pBooleanCommand("P2P_LISTEN " + timeout);
    }

    public static boolean p2pFlush() {
        return doP2pBooleanCommand("P2P_FLUSH");
    }
    ...
    public static String p2pConnect(WifiP2pConfig config, boolean joinExistingGroup) {
        ...
        return doP2pStringCommand(command);
    }

    public static boolean p2pCancelConnect() {
        return doP2pBooleanCommand("P2P_CANCEL");
    }

    public static boolean p2pGroupAdd() {
        return doP2pBooleanCommand("P2P_GROUP_ADD");
    }

    public static boolean p2pGroupRemove(String iface) {
        if (iface == null) return false;
        return doP2pBooleanCommand("P2P_GROUP_REMOVE " + iface);
    }

    public static boolean p2pReject(String deviceAddress) {
        return doP2pBooleanCommand("P2P_REJECT " + deviceAddress);
    }
    ...
    public static boolean p2pInvite(WifiP2pGroup group, String deviceAddress) {
        ...
        if (group == null) {
            return doP2pBooleanCommand("P2P_INVITE peer=" + deviceAddress);
        } else {
            return doP2pBooleanCommand("P2P_INVITE group=" + group.getInterface()
    ...
    public static boolean p2pReinvoke(int netId, String deviceAddress) {
        ...
        return doP2pBooleanCommand("P2P_INVITE persistent=" + netId + " peer=" + deviceAddress);
    }
    ...
    public static String p2pPeer(String deviceAddress) {
        return doP2pStringCommand("P2P_PEER " + deviceAddress);
    }
}
