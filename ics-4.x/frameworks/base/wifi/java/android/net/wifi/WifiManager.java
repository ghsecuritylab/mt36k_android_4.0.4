...
public class WifiManager {
   ...
   /**
     ...
     * @return {@code true} Wifi dongle does not exist.
     */
    public boolean isDongleExist() {
        try {
            return mService.isDongleExist();
        } catch (RemoteException e) {
            return false;
        }
    }
    ...
    /**
     * Remove all networks from the list of conifigured networks.
     * @return {@code true} if the operation succeeded.
     */
    public boolean removeAllNetwork() {
        try {
            return mService.removeAllNetwork();
        } catch (RemoteException e) {
            return false;
        }
    }
     ...
     * Channel number.
     * @return The current BSS info.
     */
    public CurrentBssInfo getCurrentBssInfo() {
        try {
            return mService.getCurrentBssInfo();
        } catch (RemoteException e) {
            return null;
        }
    }
